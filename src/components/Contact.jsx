    ...
    emailjs
      .send(
        ...
        "template_jyzolum", // template_id
        {
          ...
          to_email: "kenjisuzuki021@gmail.com",
      ...
      >
        ...
        <div className="my-10">
          ...
          <div className="flex flex-row items-center space-x-5 text-lg text-gray-300">
            ...
            <div>
              <p className="text-2xl">Kenji Suzuki</p>
              <a
                onClick={() => copyToClipboard("kenjisuzuki021@gmail.com")}
                className="underline cursor-pointer"
              >
                kenjisuzuki021@gmail.com
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="my-10">
          ...
          <div className="flex flex-row items-center space-x-5 text-lg text-gray-300">
            ...
            <div>
              <p className="text-2xl">lucky</p>
              <a
                onClick={() => copyToClipboard("live:.cid.59c6d19292c8b82a")}
                className="underline cursor-pointer"
              >
                live:.cid.59c6d19292c8b82a
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="my-10">
          ...
          <div className="flex flex-row items-center space-x-5 text-lg text-gray-300">
            ...
            <div>
              <p className="text-2xl">lucky</p>
              <a
                onClick={() => copyToClipboard("lucky_1021_04353")}
                className="underline cursor-pointer"
              >
                lucky_1021_04353
              </a>
        ...
        <div className="my-10">
          ...
          <div className="flex flex-row items-center space-x-5 text-lg text-gray-300">
            ...
            <div>
              <p className="text-2xl">kenji021</p>
              <a
                href="https://github.com/kenji021"
                target="_blank"
                className="underline cursor-pointer"
              >
                https://github.com/kenji021
              </a>
            </div>
          </div>
        </div>
